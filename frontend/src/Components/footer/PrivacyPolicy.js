...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <p>
                We value the trust you place in us and recognize the importance of secure transactions and information privacy. This Privacy Policy describes how Proshop Internet Private Limited and its affiliates (collectively “Proshop, we, our, us”) collect, use, share or otherwise process your personal information through Proshop website www.Proshop.com, its mobile application, and m-site (hereinafter referred to as the “Platform”).
            </p>
            <p>
            ...
            <p>
                We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us then please login into the Notification Preference page of Platform [https://www.Proshop.com/communication-preferences/email] to unsubscribe/opt-out.
            </p>
            <h6 className="topic-heading">
            ...
            <p>
                Proshop Pharma Pvt Ltd.
            </p>
            <p>
                Proshop Pharma and Warehouse near Noida Golf Course,
            </p>
            <p>
                Sector 38,  Delhi NCR,
            </p>
            ...
            <p>
                Email:Proshoppharma.officer@gmail.com
            </p>
            <p>
